...
export function Step1Hero({ onNext }: Step1HeroProps) {
  return (
    ...
    >
      ...
      <p className="mt-4 max-w-xl text-base leading-snug text-muted sm:mt-5 sm:text-lg">
        A IA da Heat Company transforma sua imagem e voz em vídeos prontos para viralizar. Veja um
        vídeo feito 100% por IA.
      </p>

      {/* Vídeo em largura total (como no original) — sem dvh, que tem suporte instável em navegadores in-app */}
